...
@SpringApplicationConfiguration(classes = {HotelListingApplication.class})
@WebAppConfiguration
@IntegrationTest
public class HireProcessTest {
    ...
    public void testHappyPath() {
        ...
        HotelListing hotelListing = new HotelListing("John Doe", "john@activiti.org", "92332344","20","100","5");
        hotelListingRepository.save(hotelListing);

        // Start process instance
        Map<String, Object> variables = new HashMap<String, Object>();
        variables.put("applicant", hotelListing);
